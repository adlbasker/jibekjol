...
class BannerController extends Controller
{
    ...
    public function store(Request $request, $lang)
    {
        ...
        return redirect($lang.'/admin/banners')->with('status', __('statuses.entry_added'));
    }
    ...
    public function update(Request $request, $lang, $id)
    {
        ...
        return redirect($lang.'/admin/banners')->with('status', __('statuses.entry_changed'));
    }
    ...
    public function destroy($lang, $id)
    {
        ...
        return redirect($lang.'/admin/banners')->with('status', __('statuses.entry_deleted'));
    }
}
