...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect($request->lang.'/admin/categories')->with('status', __('statuses.entry_added'));
    }
    ...
    public function update(Request $request, $lang, $id)
    {
        ...
        return redirect($lang.'/admin/categories')->with('status', __('statuses.entry_changed'));
    }
    ...
    public function destroy($lang, $id)
    {
        ...
        return redirect($lang.'/admin/categories')->with('status', __('statuses.entry_deleted'));
    }
}
