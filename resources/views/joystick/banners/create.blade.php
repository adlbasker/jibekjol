        ...
        <div class="card-body">
          <form action="{{ route('banners.store', $lang) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="marketing" name="marketing" minlength="2" maxlength="80" value="{{ old('marketing') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="row">
              <div class="mb-3 col-md-6">
                ...
                <input type="color" class="form-control form-control-color w-100" id="color" name="color" value="{{ old('color', '#eeeeee') }}">
              </div>
              <div class="mb-3 col-md-6">
                <label class="form-label d-block">Позиция текста</label>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="direction" id="directionLeft" value="left" checked>
                  <label class="form-check-label" for="directionLeft">По левой стороне</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="direction" id="directionRight" value="right">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="link" class="form-control" id="link" aria-describedby="basic-addon3" maxlength="255" value="{{ old('link') }}" required>
              </div>
            </div>
