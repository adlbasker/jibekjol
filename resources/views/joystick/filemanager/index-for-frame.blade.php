      ...
      <div class="col-md-6 col-xs-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="/{{ app()->getLocale() }}/admin/frame-filemanager"><i class="material-icons align-middle">home</i></a></li>
            @if ($path)
              ...
              @foreach ($crumbs as $crumb)
                ...
                @else
                  <li class="breadcrumb-item"><a href="/{{ app()->getLocale() }}/admin/frame-filemanager?path={{ $currentPath }}">{{ $crumb }}</a></li>
                @endif
              @endforeach
            @endif
          </ol>
    ...
    <div class="row g-3">
      @if ($path)
        ...
        <div class="col-6 col-sm-4 col-md-3 col-lg-2">
          <a href="/{{ app()->getLocale() }}/admin/frame-filemanager?path={{ $parentPath }}" class="fm-item fm-folder bg-white">
      ...
      @foreach ($directories as $dir)
        ...
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 position-relative">
          <a href="/{{ app()->getLocale() }}/admin/frame-filemanager?path={{ $dir }}" class="fm-item fm-folder bg-white">
