    ...
    <div class="col-md-6 mb-2">
      <ul class="nav nav-tabs">
        @foreach ($languages as $language)
          <li class="nav-item">
            <a class="nav-link @if ($language->slug == $lang) active @endif" href="/{{ $language->slug }}/admin/products/create">{{ $language->title }}</a>
          </li>
        @endforeach
      </ul>
    </div>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="title" name="title" minlength="5" maxlength="255" value="{{ old('title') }}" required>
            </div>
            <div class="mb-3">
              <label for="slug" class="form-label">URI адрес</label>
              <input type="text" class="form-control" id="slug" name="slug" minlength="2" maxlength="255" value="{{ old('slug') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="characteristic" name="characteristic" minlength="2" maxlength="80" value="{{ old('characteristic') }}">
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="count" class="form-label">Количество</label>
                  <input type="number" class="form-control" id="count" name="count" minlength="5" maxlength="80" value="{{ old('count', 1) }}">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="barcodes" class="form-label">Штрихкод</label>
                  <input type="text" class="form-control" id="barcodes" name="barcodes" value="{{ old('barcodes') }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="wholesale_price" name="wholesale_price" maxlength="10" value="{{ old('wholesale_price') }}">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="price" name="price" maxlength="10" value="{{ old('price') }}">
                    <span class="input-group-text">{{ $currency->symbol }}</span>
                  </div>
                </div>
              </div>
            ...
            <div class="mb-3">
              ...
              @foreach(trans('statuses.data') as $num => $status)
                <div class="form-check">
                  <input class="form-check-input" type="radio" id="status{{ $num }}" name="status" value="{{ $num }}" @if($num == 1) checked @endif>
              ...
              <div class="card-body py-2" style="max-height: 250px; overflow-y: auto;">
                ...
                @forelse ($grouped as $data => $group)
                  ...
                  @foreach ($group as $option)
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="options_id[]" id="option{{ $option->id }}" value="{{ $option->id }}">
            ...
            <div class="card">
              <div class="card-body py-2" style="max-height: 150px; overflow-y: auto;">
                @foreach($modes as $mode)
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="modes_id[]" id="mode{{ $mode->id }}" value="{{ $mode->id }}">
