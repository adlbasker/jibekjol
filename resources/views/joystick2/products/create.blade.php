            ...
            <div class="row">
              <div class="col-md-6" id="barcodesArea">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="barcodes" name="barcodes[]" placeholder="Штрихкод" value="{{ (old('barcodes')) ? old('barcodes') : NULL }}">
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="id_codes" name="id_codes[]" placeholder="Артикул" value="{{ (old('id_codes')) ? old('id_codes') : NULL }}">
                    </div>
                    <div class="col-md-6 col-lg-6">
