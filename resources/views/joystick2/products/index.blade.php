        ...
        @foreach ($products as $product)
          <tr>
            ...
            <td class="text-right text-nowrap">
              <a href="/{{ $lang }}/admin/products/{{ $product->id }}/copy" class="btn btn-link btn-xs" title="Копия товара" onclick="return confirm('Копировать запись?')"><i class="material-icons md-18">content_copy</i></a>
              <a href="{{ route('products.edit', [$lang, $product->id]) }}" class="btn btn-link btn-xs" title="Редактировать"><i class="material-icons md-18">mode_edit</i></a>
