      ...
      <div class="row">
        <div class="col-xs-7 col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar collapse in" id="sidebarResources">
            ...
            @can('viewAny', App\Models\Unit::class)<li @if(Request::is($lang.'/admin/units*')) class="active" @endif><a href="/{{ $lang }}/admin/units"><i class="material-icons md-20">balance</i> Единицы измерения</a></li>@endcan
