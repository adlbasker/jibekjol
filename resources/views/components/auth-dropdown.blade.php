...
<!--     <li class="nav-item">
      <a class="nav-link link-body-emphasis px-3" href="/{{ $lang }}/market/cart" aria-current="page">
        <i class="bi bi-cart"></i> {{ __('Cart') }}
        <span class="badge text-bg-info rounded-pill" id="count-items">{{ (is_array($items)) ? count($items) : 0 }}</span>
      </a>
    </li> -->
    <li class="nav-item">
